...
/*	DifferentialEvolution class contains the necessary functions for the algorithm in relation to the population of networks.
 */
...
public class DifferentialEvolution {
	...
	//creates the "trail vector" required of DE
	//@param x1 - first parent vector
	//@param x2 - second parent vector
	//@param x3 - third parent vector
