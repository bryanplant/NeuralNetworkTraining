...
/*	GeneticAlgorithm class contains the functions for a genetic algorithm and its assessment.
 */
...
public class GeneticAlgorithm {
	...
	//@param networks - list of networks representing parent population
	...
	//selects the best parents from the population
	//@param networks - the population of parents
	...
	//function to crossover parents into next generation
	//@param parents - list of parents selected from before
	...
	//@param networks - list of offspring in the new generation
